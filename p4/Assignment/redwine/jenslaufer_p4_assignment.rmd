...
A new categorical variable (is.max.total.sulfur.dioxide.exceed) for wines that exceed this limit is therefore created. We are using the limits from the EU as the wines are from Portugal.
...
We are getting a nearly normal distribution with a log10 transformation. Most of the wines are having a fixed acidity between 7.10 and 9.20 g/l and median of 7.90 g/l.
...
There 7 wines which exceeds the limit for total sulphur dioxide. It's suprising that 2 of these wines are high quality wines. Either these wines are for export outsite the EU or the winemakers are adding the sulfur dioxide to preserve it.
...
Free SO2 concentrations over 50 ppm of SO2 becomes evident in the nose and taste of wine, therefore we are checking the quality factors for wines over this limit.

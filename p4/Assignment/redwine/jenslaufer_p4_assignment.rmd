...
Many people talk about the quality of wine, but actual
...
We also create a new variable for spoiled and non-spoiled wines. According to https://glossary.wein-plus.eu/schwefelsaeure a wine is spoiled if the sufalt is higher than 0.92 g
...
df$is_spoiled <- ifelse(df$sulphates <= 0.92, FALSE, TRUE)
```
...
```{r}
df %>% 
   ggplot(mapping=aes(x=is_spoiled)) +
   geom_bar() +

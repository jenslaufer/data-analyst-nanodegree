...
Most of the variables were positively skewed or long tail distritutions, a log10 tranformation was mostly done to get a kind of normal distribution. 
...
### Free Sulphur Dioxide vs Qaulity

Free SO2 concentrations over 50 ppm of SO2 becomes evident in the nose and taste of wine, therefore the quality factors for wines over this limit are checked.


There could not be found a proof for this
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=5, fig.width=10}
df %>%

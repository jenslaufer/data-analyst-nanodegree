...
grid.arrange(qplot(listings_df$occupancy),
             qplot(listings_df$revenue_per_available_room),
             qplot(listings_df$average_daily_rate),
             qplot(listings_df$yearly_revenue),
             qplot(listings_df$bathrooms),
             qplot(listings_df$bedrooms),
             qplot(listings_df$beds),
             qplot(listings_df$person_capacity),
             qplot(listings_df$picture_count),
             qplot(listings_df$reviews_count),
             qplot(listings_df$room_type),
             qplot(listings_df$star_rating),
             qplot(listings_df$instant_bookable),
             qplot(listings_df$is_family_preferred),
             ncol = 5)
```
...
ggplot(data=listings_df, mapping=aes(x=yearly_revenue)) +
   geom_freqpoly(binwidth=0.07, color=I('red')) +
  scale_x_log10()
...
ggplot(data=listings_df, mapping = aes(x=average_daily_rate,y=yearly_revenue)) +
  geom_point(alpha=1/8, mapping=aes(fill=person_capacity)) +
...
ggpairs(listings_df, columns=8:19)
```
```{r}

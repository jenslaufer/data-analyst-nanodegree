...
just have 3 data points. This has to be kept in mind for the feature selection.
...
Outliers need to be removed from the dataset. As fraud detection is the goal of the study this 
has to be done with 
cautious as some POIs have outliers in their financial data. These outliers are
essential and cannot be thrown away as they characterize a POI. So just undesired outliers can be removed.

...
labels_predicted = cls.predict(features_test)

print confusion_matrix(labels_test, labels_predicted)
print accuracy_score(labels_test, labels_predicted)
print precision_score(labels_test, labels_predicted)
print recall_score(labels_test, labels_predicted)
print f1_score(labels_test, labels_predicted)
